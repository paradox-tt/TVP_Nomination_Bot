...
function _extractCompositeSet2(_, params, fields) {
  ...
  return (0, _encodeTypes.withTypeString)(this.registry, {
    ...
    sub: this.getSiType(params[0].type.unwrap()).def.asVariant.variants.map(_ref17 => {
      let {
        index,
        name
      } = _ref17;
...
function _extractSequence2(lookupIndex, _ref18) {
  let {
    type
  } = _ref18;
...
function _extractVariant2(lookupIndex, _ref19, _ref20) {
  let {
    params,
    path
  } = _ref19;
...
function _extractVariantEnum2(lookupIndex, variants) {
  ...
  [...variants].sort((a, b) => a.index.cmp(b.index)).forEach(_ref22 => {
    let {
      fields,
      index,
      name
