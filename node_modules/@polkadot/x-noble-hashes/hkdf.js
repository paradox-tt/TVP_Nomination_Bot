...
import { hmac } from "./hmac.js"; // HKDF (RFC 5869)
...
export function hkdf_extract(hash, ikm, salt) {
  assertHash(hash); // NOTE: some libraries treats zero-length array as 'not provided', we don't, since we have undefined as 'not provided'
