...
export const shrSL = (h, l, s) => h << 32 - s | l >>> s; // Right rotate for Shift in [1, 32)

export const rotrSH = (h, l, s) => h >>> s | l << 32 - s;
export const rotrSL = (h, l, s) => h << 32 - s | l >>> s; // Right rotate for Shift in (32, 64), NOTE: 32 is special case.

export const rotrBH = (h, l, s) => h << 64 - s | l >>> s - 32;
export const rotrBL = (h, l, s) => h >>> s - 32 | l << 64 - s; // Right rotate for shift===32 (just swaps l&h)

export const rotr32H = (h, l) => l;
export const rotr32L = (h, l) => h; // Left rotate for Shift in [1, 32)

export const rotlSH = (h, l, s) => h << s | l >>> 32 - s;
export const rotlSL = (h, l, s) => l << s | h >>> 32 - s; // Left rotate for Shift in (32, 64), NOTE: 32 is special case.

export const rotlBH = (h, l, s) => l << s - 32 | h >>> 64 - s;
export const rotlBL = (h, l, s) => h << s - 32 | l >>> 64 - s; // JS uses 32-bit signed integers for bitwise operations which means we cannot
