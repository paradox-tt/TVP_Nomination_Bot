...
exports.SIGMA = exports.BLAKE2 = void 0;
...
class BLAKE2 extends _utils.Hash {
  constructor(blockLen, outputLen) {
    ...
    (0, _utils.assertNumber)(blockLen);
    (0, _utils.assertNumber)(outputLen);
    (0, _utils.assertNumber)(keyLen);
    ...
    this.buffer32 = (0, _utils.u32)(this.buffer = new Uint8Array(blockLen));
  }
