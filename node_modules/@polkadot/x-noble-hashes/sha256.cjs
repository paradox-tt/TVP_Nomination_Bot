...
class SHA256 extends _sha.SHA2 {
  ...
  process(view, offset) {
    ...
    for (let i = 16; i < 64; i++) {
      ...
      const s0 = (0, _utils.rotr)(W15, 7) ^ (0, _utils.rotr)(W15, 18) ^ W15 >>> 3;
      const s1 = (0, _utils.rotr)(W2, 17) ^ (0, _utils.rotr)(W2, 19) ^ W2 >>> 10;
    ...
    for (let i = 0; i < 64; i++) {
      const sigma1 = (0, _utils.rotr)(E, 6) ^ (0, _utils.rotr)(E, 11) ^ (0, _utils.rotr)(E, 25);
      const T1 = H + sigma1 + Chi(E, F, G) + SHA256_K[i] + SHA256_W[i] | 0;
      const sigma0 = (0, _utils.rotr)(A, 2) ^ (0, _utils.rotr)(A, 13) ^ (0, _utils.rotr)(A, 22);
...
const sha256 = (0, _utils.wrapConstructor)(() => new SHA256());
