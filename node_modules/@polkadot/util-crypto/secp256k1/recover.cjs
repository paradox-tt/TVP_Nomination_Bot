...
var _xNobleSecp256k = require("@polkadot/x-noble-secp256k1");
...
function secp256k1Recover(msgHash, signature, recovery) {
  ...
  const publicKey = !_util.hasBigInt || !onlyJs && (0, _wasmCrypto.isReady)() ? (0, _wasmCrypto.secp256k1Recover)(msg, sig, recovery) : (0, _xNobleSecp256k.recoverPublicKey)(msg, _xNobleSecp256k.Signature.fromCompact(sig).toRawBytes(), recovery);
