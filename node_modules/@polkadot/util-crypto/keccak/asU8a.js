...
import { createAsHex, createBitHasher } from "../helpers.js";
...
export function keccakAsU8a(value, bitLength = 256, onlyJs) {
  ...
  return !hasBigInt || !onlyJs && isReady() ? is256 ? keccak256(u8a) : keccak512(u8a) : is256 ? keccak256Js(u8a) : keccak512Js(u8a);
}
/**
 * @name keccak256AsU8a
