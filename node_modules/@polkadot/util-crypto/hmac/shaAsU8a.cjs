...
var _hmac = require("@polkadot/x-noble-hashes/hmac");

var _sha = require("@polkadot/x-noble-hashes/sha256");

var _sha2 = require("@polkadot/x-noble-hashes/sha512");
...
function hmacShaAsU8a(key, data) {
  ...
  return !_util.hasBigInt || !onlyJs && (0, _wasmCrypto.isReady)() ? is256 ? (0, _wasmCrypto.hmacSha256)(u8aKey, data) : (0, _wasmCrypto.hmacSha512)(u8aKey, data) : is256 ? (0, _hmac.hmac)(_sha.sha256, u8aKey, data) : (0, _hmac.hmac)(_sha2.sha512, u8aKey, data);
}
/**
